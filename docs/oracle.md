...
```bash
nohup python indexer.py zakerzonia_lutsk "https://drive.google.com/drive/folders/1L-W-0TKnNmPaspibJlAnL-VhZnxPu3n2?usp=drive_link" --extended-prompt zakerzonia --request-delay 20 </dev/null >>nohup.out 2>&1 &
```